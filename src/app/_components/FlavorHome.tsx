  ...
  return (
    ...
    >
      <div className="relative z-10 flex w-full max-w-4xl flex-col items-center gap-8">
        ...
        {/* Icons Section */}
        <div className="flex items-center justify-center gap-8 sm:mt-4 md:gap-12">
          <Image
            src={SunWhite}
            alt=""
...
const Cards = () => {
  ...
  return (
    <div className="relative z-10 mt-8 flex w-full max-w-7xl flex-col items-center gap-6 px-4 sm:mt-16">
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="relative h-fit w-full overflow-hidden bg-white sm:min-h-[300px]">
            <Image
              src={normal}
              alt={`Card ${index + 1}`}
              height={300}
